        ...
        <div class="mx-auto md:w-4/5 w-full py-24 px-3 sm:py-32 lg:px-8">
            <div
                ...
                <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                    ...
                    <p class="mt-4 text-gray-500">Для начала пользованиями всеми функциями подтвердите Вашу почту, перейдя
                    ...
                    <div class="mt-3 flex justify-center gap-x-6 lg:justify-start items-center ">
                        <form action="{{ route('verification.send') }}" method="post" class="resend_verification">
                            <button
                                class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Отправить ещё раз</button>
                        </form>
                    </div>
                </div>
