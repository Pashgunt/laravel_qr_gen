...
@section('content')
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div
            class="relative sm:w-80 mx-auto md:w-4/5 lg:w-1/2 bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-lg sm:px-10 border @if (Session::has('status')) border-green-300 @endif">
                    ...
                    <form action="{{ route('password.email') }}" method="POST">
                        ...
                        <div class="flex items-center justify-center flex-col">
                            ...
                            <p id="helper-text-explanation" class="mt-2 text-center text-sm italic text-gray-500">
                                После отправки письма вам на почту придёт сообщение с ссылкой, по которой нужно перейти <a
                                    href="" class="not-italic font-medium text-blue-600 hover:underline">Подробнее
                                    ...</a>
                            </p>
                        </div>
                    </form>
