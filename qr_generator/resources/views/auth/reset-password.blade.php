            ...
            <div class="mx-auto max-w-md">
                ...
                <div class="">
                    <form action="{{ route('password.update') }}" method="post">
                        ...
                        @enderror
                        "
                                placeholder="email@mail.ru" value="{{ old('email') ?? app('request')->input('email') }}">
                            @error('email')
                        ...
                        <div class="mb-4 password__wrapper">
                            <label for="password"
                                class="block mb-2 text-sm font-medium text-gray-900 @error('password') text-red-500 @enderror">Новый
                                пароль
                            ...
                            <div class="bar mt-2">
                                <div class="bar__title text-xs mb-1">Введите новый пароль!</div>
