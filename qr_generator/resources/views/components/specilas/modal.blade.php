<div class="relative z-10" :class="!show ? 'hidden' : 'show'" id="defaultModal" tabindex="-1" aria-hidden="true"
    role="dialog">
    <div class="fixed inset-0 bg-gray-500/[.75] transition-opacity" @click="show = !show"></div>
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 dark:bg-gray-800">
                    <div class="">
                        ...
                        <div class="mt-3 text-center sm:ml-4">
                            <h3 class="text-xl font-semibold leading-6 text-gray-900 dark:text-gray-200" id="modal-title">
                                {{ $title }}
                            </h3>
                            <div class="mt-2">
